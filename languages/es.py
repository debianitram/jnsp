...
'Enter a value': 'Ingresar un valor',
...
'Información adicional / Consultas': 'Información adicional / Consultas',
'Ingresar': 'Ingresar',
...
'Value not allowed': 'Valor no encontrado',
